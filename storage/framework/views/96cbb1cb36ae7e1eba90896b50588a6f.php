...
<?php $__env->startSection('content'); ?>
    <div class="min-h-screen flex items-center justify-center bg-gray-100">
        <div class="bg-white p-8 rounded-lg shadow-lg w-full max-w-md">
            ...
            <form action="<?php echo e(route('cadastro')); ?>" method="post">
                ...
                <div class="mb-2">
                    Já possui conta?<a class="ml-1 hover:text-blue-400 hover:cursor-pointer" href="<?php echo e(route('loginUser')); ?>">Acesse aqui</a>
                </div>
                <!-- Cadastrar -->
                <div class="mb-6">
...
<?php echo $__env->make('index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Usuario\Downloads\SecondSite-main (1)\SecondSite-main\resources\views/page/auth/registerUser.blade.php ENDPATH**/ ?>