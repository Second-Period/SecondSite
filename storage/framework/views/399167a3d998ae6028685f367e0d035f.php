                ...
                <table class="roudend-lg table-auto mx-auto divide-y divide-gray-700 min-w-full">
                    <thead>
                        <tr class="divide-x divide-gray-600 sm:overflow-x-auto">
                            ...
                            <th class="p-4 text-md text-center text-gray-100 tracking-normal"><?php echo e(__('Product')); ?></th>
                            <th class="p-4 text-md text-center text-gray-100 tracking-normal"><?php echo e(__('Price')); ?></th>
                    ...
                    <tbody class="bg-gray-800 divide-y divide-gray-600">
                        <?php $__currentLoopData = $products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr class="divide-x divide-gray-600">
                                <td class="p-2 text-md text-center text-gray-100 tracking-normal"><?php echo e($product->id); ?></td>
                                <td class="p-2 text-md text-center text-gray-100 tracking-normal" ><a class="p-1 hover:bg-gray-500 hover:rounded-md" href="<?php echo e(route('products.detail', $product->id)); ?>"><?php echo e($product->name); ?></a></td>
                                <td class="p-2 text-md text-center text-gray-100 tracking-normal"><?php echo e($product->price); ?></td>
                                <td class="p-2 text-md text-center text-gray-100 tracking-normal"><?php echo e($product->created_at); ?></td>
                                <?php if($product->created_at != $product->updated_at): ?>
                                    <td class="p-2 text-md text-center text-gray-100 tracking-normal"><?php echo e($product->updated_at); ?></td>
                                <?php else: ?>
